                        ...
                        <tr>
							...
							<td>
							    <div class="action-buttons">
							        <a href="${pageContext.request.contextPath}/customers?view=detail&customerName=${customer.customerName}" 
							           class="action-btn detail-btn">
							            <i class="fas fa-info-circle"></i>
							        </a>
							        <a href="${pageContext.request.contextPath}/customers?view=edit&name=${customer.customerName}" 
							           class="action-btn edit-btn">
							            <i class="fas fa-edit"></i>
							        </a>
							        <button class="action-btn delete-btn" onclick="deleteCustomer('${customer.customerName}')">
