    ...
    private boolean insertCustomerDetail(CustomerDetailDTO detail) {
        ...
        try {
            ...
            String sql = "INSERT INTO vertica_customer_detail (" +
                    "customer_name, customer_manager, si_company, si_manager, creator, create_date, " +
    ...
    private boolean updateCustomerDetail(CustomerDetailDTO detail) {
        ...
        try {
            ...
            String sql = "UPDATE vertica_customer_detail SET " +
                    "customer_manager = ?, si_company = ?, si_manager = ?, creator = ?, create_date = ?, " +
            ...
            pstmt.setString(1, detail.getCustomerManager());     // customer_manager
            pstmt.setString(2, detail.getSiCompany());           // si_company
            pstmt.setString(3, detail.getSiManager());           // si_manager
            pstmt.setString(4, detail.getCreator());             // creator
            
            if (detail.getCreateDate() != null) {
                pstmt.setTimestamp(5, new Timestamp(detail.getCreateDate().getTime()));
            } else {
                pstmt.setTimestamp(5, null);
            }
            
            pstmt.setString(6, detail.getMainManager());         // main_manager
            pstmt.setString(7, detail.getSubManager());          // sub_manager
            
            if (detail.getInstallDate() != null) {
                pstmt.setTimestamp(8, new Timestamp(detail.getInstallDate().getTime()));
            } else {
                pstmt.setTimestamp(8, null);
            }
            
            pstmt.setString(9, detail.getIntroductionYear());    // introduction_year
            pstmt.setString(10, detail.getDbName());             // db_name
            pstmt.setString(11, detail.getDbMode());             // db_mode
            pstmt.setString(12, detail.getVerticaVersion());     // vertica_version
            pstmt.setString(13, detail.getLicenseInfo());        // license_info
            pstmt.setString(14, detail.getSaid());               // said
            pstmt.setString(15, detail.getNodeCount());          // node_count
            pstmt.setString(16, detail.getVerticaAdmin());       // vertica_admin
            pstmt.setString(17, detail.getSubclusterYn());       // subcluster_yn
            pstmt.setString(18, detail.getMcYn());               // mc_yn
            pstmt.setString(19, detail.getMcHost());             // mc_host
            pstmt.setString(20, detail.getMcVersion());          // mc_version
            pstmt.setString(21, detail.getMcAdmin());            // mc_admin
            pstmt.setString(22, detail.getBackupYn());           // backup_yn
            pstmt.setString(23, detail.getCustomResourcePoolYn()); // custom_resource_pool_yn
            pstmt.setString(24, detail.getBackupNote());         // backup_note
            pstmt.setString(25, detail.getOsInfo());             // os_info
            pstmt.setString(26, detail.getMemoryInfo());         // memory_info
            pstmt.setString(27, detail.getInfraType());          // infra_type
            pstmt.setString(28, detail.getCpuSocket());          // cpu_socket
            pstmt.setString(29, detail.getHyperThreading());     // hyper_threading
            pstmt.setString(30, detail.getCpuCore());            // cpu_core
            pstmt.setString(31, detail.getDataArea());           // data_area
            pstmt.setString(32, detail.getDepotArea());          // depot_area
            pstmt.setString(33, detail.getCatalogArea());        // catalog_area
            pstmt.setString(34, detail.getObjectArea());         // object_area
            pstmt.setString(35, detail.getPublicYn());           // public_yn
            pstmt.setString(36, detail.getPublicNetwork());      // public_network
            pstmt.setString(37, detail.getPrivateYn());          // private_yn
            pstmt.setString(38, detail.getPrivateNetwork());     // private_network
            pstmt.setString(39, detail.getStorageYn());          // storage_yn
            pstmt.setString(40, detail.getStorageNetwork());     // storage_network
            pstmt.setString(41, detail.getEtlTool());            // etl_tool
            pstmt.setString(42, detail.getBiTool());             // bi_tool
            pstmt.setString(43, detail.getDbEncryption());       // db_encryption
            pstmt.setString(44, detail.getCdcTool());            // cdc_tool
            
            if (detail.getEosDate() != null) {
                pstmt.setTimestamp(45, new Timestamp(detail.getEosDate().getTime()));
            } else {
                pstmt.setTimestamp(45, null);
            }
            
            pstmt.setString(46, detail.getCustomerType());       // customer_type
            pstmt.setString(47, detail.getNote());               // note
            pstmt.setString(48, detail.getCustomerName());       // WHERE 조건
